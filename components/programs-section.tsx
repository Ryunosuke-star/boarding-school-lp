        ...
        <div className="relative overflow-hidden bg-white shadow-md rounded-lg h-full flex flex-col">
          ...
          <div className="p-6 flex flex-col justify-between flex-grow">
            ...
            <a href="https://boardingschool.jp/about/" 
              className="inline-block bg-[#c6a664] text-white text-lg py-2 px-4 rounded shadow hover:opacity-90 transition">
                詳細を見る
              </a>
            </div>
          </div>
      ...
      >
        <div className="relative overflow-hidden bg-white shadow-md rounded-lg h-full flex flex-col">
          ...
          <div className="p-6 flex flex-col justify-between flex-grow">
            ...
            <div className="mt-6 text-center">
            <a href="https://boardingschool.jp/summer-school/" className="inline-block bg-[#c6a664] text-white text-lg py-2 px-4 rounded shadow hover:opacity-90 transition">
                詳細を見る
              </a>
            </div>
          </div>
