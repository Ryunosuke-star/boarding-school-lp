      ...
      <div className="container px-4 mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 transition-all duration-1000">
          ...
          <div
            ...
            className="group relative overflow-hidden bg-white shadow-md rounded-lg p-6 flex flex-col items-center justify-center cursor-pointer hover:shadow-lg transition-shadow min-h-[320px]"
          >
          ...
          <a
            href="tel:0365551642"
            className="group relative overflow-hidden bg-white shadow-md rounded-lg p-6 flex flex-col items-center justify-center hover:shadow-lg transition-shadow min-h-[320px]"
          >
            <div className="bg-black text-white rounded-full w-14 h-14 flex items-center justify-center mb-6">
              <Phone size={28} />
            </div>
