      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div
            ...
            className="border rounded-lg p-6 flex flex-col items-center justify-center cursor-pointer hover:shadow-lg transition-shadow min-h-[320px]"
          >
          ...
          <a
            href="tel:0365551642"
            className="border rounded-lg p-6 flex flex-col items-center justify-center hover:shadow-lg transition-shadow min-h-[320px]"
          >
            <div className="bg-black text-white rounded-full w-12 h-12 flex items-center justify-center mb-4">
              <Phone size={24} />
            </div>
